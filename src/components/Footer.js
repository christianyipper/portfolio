...
import HeadingFloat from './text/HeadingFloat';
        ...
        <footer ref={ footer }>
            <div className="footer-wrap">
                ...
                <div className="footer-mid">
                    <img className={ `gif-overlay ${ footerView ? `footer-blur-in` : `footer-blur-out` }` } src="https://www.dropbox.com/scl/fi/rf1u88wl47o3ni7vo7ltn/yipper-profile-overlay-400p-27fps-comp.gif?rlkey=bdevz0gcrtbgz4ygq8y1hrtne&st=r9liec8y&raw=1" alt='Christian Yip "Yipper" profile shirt gif'/>
                    <img className={ `${ footerView ? `footer-blur-in` : `footer-blur-out` }` } src="https://www.dropbox.com/scl/fi/wrixsoyia5q9jsfa6qrll/yipper-profile-gif-head.png?rlkey=qiqbj024tymoh12989wp7mxde&st=p84n445d&raw=1" alt='Christian Yip "Yipper" profile photo head shot'/>
                </div>
