const HeadingFloat = ( { animation, reference, meta, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, spaceA, spaceB, spaceC, spaceD, spaceE, spaceF,spaceG, spaceH, spaceI, spaceJ, spaceK, spaceL, spaceM, spaceN, spaceO, spaceP } ) => {

    return (
        <div ref={ reference } className={ animation }>
            <h2 className="heading-float">
            ...
            <h2 className="none">{ meta }</h2>
        </div>
    );
};

export default HeadingFloat;