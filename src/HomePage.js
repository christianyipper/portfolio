        ...
        <main className="home">
            <section className="home-section">
                <div className="banner-img-wrap">
                    <img className="gif-overlay" src="https://drive.google.com/thumbnail?id=1Bte1A_4zvXfSjEKZowGW6aYxpsmwBDp3&sz=w1000" alt='Christian Yip "Yipper" thinking profile shirt gif'/>
                    <img className="gif-bg" src="https://drive.google.com/thumbnail?id=12z8OMAlIARPn2S86BKntIDmvItdc61Az&sz=w1000" alt='Christian Yip "Yipper" thinking profile photo head shot'/>
