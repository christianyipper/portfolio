                ...
                <div className="artifact-wrap">
                    <article className={ `artifact-left left-lg heading-col ${ inView1 ? "blur-in" : "blur-out" }` }>
                        <TitleFloat 
                            ...
                            meta="Stripes Nation" 
                            a="S" b="o" c="n" d="i" e="c" spaceF="space" f="A" g="n" h="i" i="m" j="a" k="t" l="i" m="o" o="n" p="."
                        />
                        <HeadingShimmer 
                    ...
                    <div className="artifact-right right-sm">
                        <TableOfContents
                            ...
                            subHeading1="Photoshop"
                            mainHeading1="Asset Creation"
                            path1="#LogoConcepts"
                            num1="1"
                            display1="toc-display"

                            subHeading2="HTML | CSS | JavaScript"
                            mainHeading2="Starting Screen"
                            path2="#LogoDevelopment"
                            num2="2"
                            display2="toc-display"

                            subHeading3="HTML | CSS"
                            mainHeading3="Video Game"
                            path3="#MarketingMockups"
                            num3="3"
                            display3="toc-display"

                            subHeading4="HTML | CSS | JavaScript"
                            mainHeading4="Pause Screen"
                            path4="#BumperVideo"
                            num4="4"
